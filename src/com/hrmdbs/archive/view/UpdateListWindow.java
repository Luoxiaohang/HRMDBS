...
public class UpdateListWindow extends JFrame implements MouseListener {
	...
	public UpdateListWindow(ArrayList<Employee> es) {
		this.es = es;
		initData();
		initWindow();
	}
	...
	public static void main(String[] args) {
		UpdateListWindow checkWindow = new UpdateListWindow();
		checkWindow.initWindow();
	}

	public void mouseClicked(MouseEvent e) {
		if (e.getButton() == MouseEvent.BUTTON1) {
			new UpdateWindow(es.get(jt.getSelectedRow()));
		}
	}
