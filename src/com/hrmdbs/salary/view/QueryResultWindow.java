...
public class QueryResultWindow extends JFrame implements MouseListener {
	...
	public QueryResultWindow(HashMap<Integer, ArrayList<SalaryStand>> es) {
		this.sris = es;
		initDate();
		initWindow();
	}
	...
	public static void main(String[] args) {
		new QueryResultWindow(null);
	}

	private void initDate() {
		int i = 0;
		for (Entry<Integer, ArrayList<SalaryStand>> sss : sris.entrySet()) {
			info[i][0] = String.valueOf(sss.getKey());
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			if (info[selectRow][0] != null) {
				int registInfoId = Integer.valueOf(String.valueOf(jt
						.getValueAt(jt.getSelectedRow(), 0)));
				new SalaryStandDetailWindow(sris.get(registInfoId));
			}
		}
	}
