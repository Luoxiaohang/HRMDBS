...
public class QueryResultWindow extends JFrame implements MouseListener {
	...
	public QueryResultWindow(ArrayList<Employee> es) {
		this.es = es;
		initData();
		initWindow();
	}
	...
	public static void main(String[] args) {
		QueryResultWindow checkWindow = new QueryResultWindow();
		checkWindow.initWindow();
	}

	public void mouseClicked(MouseEvent e) {
		if (e.getButton() == MouseEvent.BUTTON1) {
			String hird = info[jt.getSelectedRow()][0];
			if (hird != null) {
				new DetailInfoWindow(es.get(jt.getSelectedRow()));
			}
		}
	}
